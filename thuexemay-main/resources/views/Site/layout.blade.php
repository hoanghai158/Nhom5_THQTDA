...
<body>
                    ...
                    <div class="header__top-left">
                        <div class="header__top-left--logo">
                            <a href="/" class="header__logo">
                                <img src="./tainguyen/asset/img/logo/logo.jpg" alt="">
                            </a>
                        </div>
                    </div>
                        ...
                        <ul class="header__top-right--list">
                            ...
                            <li class="header__top-right--item list-policy">CHÍNH SÁCH
                                ...
                                <ul class="subnav-policy">
                                    <a href="chinh-sach"><li class="item-policy">CHÍNH SÁCH THUÊ XE MÁY</li></a>
 ...
 <div class="footer">
                    ...
                    <div class="col l-3">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                <p>Dịch vụ cho thuê xe máy tự lái chuyên nghiệp tại Việt Nam.</p>
                                <p><i class="fa-solid fa-phone"></i>Tổng đài (24/24H): <a href="/">0397 135 609</a></p>
                                <p><i class="fa-solid fa-envelope"></i><a href="/">team5_2001.yt@gmail.com</a></p>
    ...
    <!-- Plugin cmt -->
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0" nonce="9My97UMe"></script>
    <div id="comment">
